...
def load_data():
    try:
        # Ruta relativa al archivo Excel (en la misma carpeta que el script)
        file_path = "1-2 RFEF 23Enero2025.xlsx"
...
# Verificar las columnas del DataFrame (para depuración)
